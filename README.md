# L4LF46SL-2025
Documents et données du cours de méthodologie (L3 SdL S2 2025-2026)

Ce dépôt Git est réservé au TD de méthodologie correspondant au code L4LF46SL.

Vous y trouverez les liens et les fichiers de données utilisés en cours.
...
- [Lexique des verbes français et Dictionnaire des mots français](http://rali.iro.umontreal.ca/rali/?q=fr/versions-informatisees-lvf-dem)
...
- Analyse automatisée de fils WhatsApp : [WhatsAnalyse](https://whatsanalyze.com/fr), [Chatilizer](https://chatilyzer.com/)
- [Voyant Tools](https://voyant-tools.org/)
- [Atlas sonore des variétés dialectales](https://atlas.lisn.upsaclay.fr/)
- [Corpus DiCo](http://redac.univ-tlse2.fr/lexicons/dico.html)

## Outils LaTeX
- [Apprendre LaTeX en ligne](https://www.learnlatex.org/fr/) et/ou avec [une sandbox](https://learnlatex.edulatex.xyz/)
